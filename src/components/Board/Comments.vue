    ...
    <div class="ReplyBox">
      <div class="box_left">
        <div class="like_board">
          ...
          ><span style="padding: 0px 5px 0px 2px; color: black;">좋아요 2</span>
        </div>
        <a
          href="#"
          role="button"
          aria-pressed="true"
          class="button_comment not_allowed"
        >
          <span class="icon_area">
            댓글<strong class="num">{{ commentList.length }}</strong>
          </span>
        </a>
      </div>
          ...
          >
            <div class="comment_area">
              <div class="comment_box">
                ...
                <span v-else>
                  <div style="color: darkgrey; padding: 7px 0px 7px 5px;">이 댓글은 삭제된 댓글입니다.</div>
                </span>
                <!-- 댓글 삭제 -->
                <comment-delete
...
<style scoped src="@/assets/styles/comments.css">
.deleteComment {
    padding-bottom: 1px;
}
</style>
